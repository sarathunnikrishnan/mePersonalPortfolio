  ...
  experience: [
    {
      ...
      date: "2025 - Present",
      description:
        "Developing and maintaining scalable full-stack web applications using the MERN stack. Implementing secure authentication using JWT and role-based access control. Optimizing performance and integrating third-party APIs.",
    },
    {
      id: 2,
      type: "work",
      ...
      date: "2024 - 2025",
      description:
        "Built responsive web applications using MongoDB, Express.js, React.js, and Node.js. Developed reusable React components and integrated RESTful APIs for dynamic functionality. Assisted in MongoDB database design.",
    },
    {
      id: 3,
      type: "education",
      ...
      date: "2024",
      description:
        "Completed intensive training in full-stack web development with practical exposure to MERN stack technologies and real-world projects.",
    },
    {
      id: 4,
      type: "work",
      ...
      date: "2019 - 2023",
      description:
        "Managed daily pipeline operations and ensured workflow efficiency. Led and mentored operational teams to achieve project targets.",
    },
    {
      id: 5,
      type: "education",
    ...
    items: [
      {
        ...
        description:
          "A full-stack e-commerce style bridal shopping platform with secure user authentication and product management features. Includes shopping cart and responsive interface.",
        tech: ["React.js", "Node.js", "Express.js", "MongoDB"],
        liveLink: "https://black-and-white-smoky.vercel.app",
        githubLink:
          "https://github.com/sarathunnikrishnan/Bridal_Application_App",
      },
      {
        id: 2,
        ...
        description:
          "An interactive quiz platform designed to improve children’s learning and IQ assessment experience with dynamic quiz rendering and smooth user experience.",
        tech: ["React.js", "Node.js", "Express.js", "HTML/CSS"],
        liveLink: "https://edutism-quiz-app-phcp.vercel.app",
